    ...
    def forward(self, x):
        ...
        for i in range(self.num_layers):
            ...
            if i in self.out_indices:
                ...
                outs.append(out)
        outs = {f'{i}': outs[i] for i in range(len(outs))}
        return outs
...
class SwinTransfomerNet(SwinTransformer):
    def __init__(self, name='swin_small'):
        ...
        tiny_cfg = dict(
            ...
            drop_rate=0., attn_drop_rate=0., out_indices=(1, 2, 3),)
        ...
        cfgs = {'swin_tiny': tiny_cfg, 'swin_small': small_cfg, 'swin_base': base_cfg}
        cfgs = cfgs[name]
        super(SwinTransfomerNet, self).__init__(**cfgs)
