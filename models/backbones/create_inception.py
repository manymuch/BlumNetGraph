...
class InceptionD(nn.Module):
    ...
    def __init__(self, in_channels, conv_block=None):
        ...
        self.branch7x7x3_4 = conv_block(192, 192, kernel_size=3, stride=2, padding=1)
